...
#define BTM_BLE_APCF_ENABLE_LEN      2
...
/* BLE APCF CFG header: 1 bytes of sub_code, 1 byte of APCF action, 1 byte of Fliter index */
#define BTM_BLE_APCF_CFG_HDR_LENGTH      3
#define BTM_BLE_APCF_FILT_FEAT_SELN_LEN  7
#define BTM_BLE_APCF_ADDR_LEN            7
#define BLE_APCF_ADDR_PUBLIC             0x00
#define BLE_APCF_ADDR_RANDOM             0x01
#define BLE_APCF_ADDR_NA                 0x02
...
typedef struct
{
    ...
    tBTM_BLE_APCF_CFG_CMPL_CBACK    *p_apcf_cfg_cback;
    tBTM_BLE_APCF_ENABLE_CMPL_CBACK *p_apcf_enable_cback;
}tBTM_BLE_BRCM_CB;
