...
#define BTA_RT_READ_AUDIO_INFO          7
...
/* Event associated with BTA_RT_READ_AUDIO_INFO */
typedef struct
{
    tAUDIO_CONFIG_STATUS    status;
    UINT16                  codec_info;
    UINT16                  audio_path_table[MAX_AUDIO_ROUTE_SRC][MAX_AUDIO_ROUTE_MIX];
} tBTA_RT_READ_AUDIO_INFO;
...
typedef union
{
    ...
    tBTA_RT_RESP            resp;
    tBTA_RT_READ_AUDIO_INFO audio_info;
} tBTA_RT;
...
/*******************************************************************************
**
** Function         BTA_RtReadAudioInfo
**
** Description      Read audio routing info from the controller, such as supported
**                  codec type and btsnk routing path
**
** Parameters
**
** Returns          None
**
*******************************************************************************/
BTA_API extern void BTA_RtReadAudioInfo (UINT16 rt_handle);
