...
#ifndef QL_NF3303_BT_STACK_H 
#define QL_NF3303_BT_STACK_H 
#include <stdint.h>
...
typedef enum
{
    ...
    NFBT_ERR_BT_PCM_IN_BLOCKING_LONGTIME,
    NFBT_ERR_BT_PCM_OUT_BLOCKING_LONGTIME,
    NFBT_ERR_SYS_SCO_MIC_BLOCKING_LONGTIME,
    NFBT_ERR_SYS_SCO_AUDIO_BLOCKING_LONGTIME,
    NFBT_ERR_SYS_A2DP_AUDIO_BLOCKING_LONGTIME,
    NFBT_ERR_SYS_RING_AUDIO_BLOCKING_LONGTIME,
    ...
    NFBT_WARNING_BT_CB_BLOCKING_LONGTIME,
...
#define BLE_ADV_SHOW_NAME        1 //show BLE Advertising name
#define BLE_ADV_SHOW_NONE_NAME   0 //show BLE Advertising name

/* GATT Notification Indication definition */
#define GATT_NOTIFICATION_DEF    0x1
#define GATT_INDICATION_DEF      0x0

typedef enum
{
	GATT_ADV_CONNECT_CAP = 0x01,
	GATT_ADV_SERVICE_UUID = 0x03,
    GATT_ADV_COMPLETE_LOCAL_NAME = 0x9,
	GATT_ADV_FEATURES = 0x19,
} GATT_ADV_TYPE;
...
typedef void(*NFCBK_DiagnosticMessage)(DIAG_ID code);
...
typedef void (*NFCBK_HFP_DeviceNotification)(BT_ADDR *addr, HFP_DEVICE_NOTIFY_PROP notify_prop, nfUINT8 notify_prop_state);
...
**    DSP API function    **
***************************/
BLUEGATE_PUBLIC_API bt_status NFBT_DSP_SpkVolume(BT_ADDR *addr, nfUINT8 volume);
