...
typedef void (tBTA_AVK_REG) (tBTA_AVK_HNDL hndl, tAVDT_CS *p_cs, char *p_service_name, void *p_data);
...
**
*******************************************************************************/
BTA_API void BTA_AvkDeregister(tBTA_AVK_HNDL hndl);  /* BSA_SPECIFIC */
...
**
*******************************************************************************/
BTA_API void BTA_AvkCloseSig(tBTA_AVK_HNDL hndl);
...
**
*******************************************************************************/
BTA_API void BTA_AvkCloseStr(tBTA_AVK_HNDL hndl);   /* BSA_SPECIFIC */
...
**
*******************************************************************************/
BTA_API void BTA_AvkStart(tBTA_AVK_HNDL hndl);
...
**
*******************************************************************************/
BTA_API void BTA_AvkStop(tBTA_AVK_HNDL hndl,BOOLEAN suspend);
...
**
*******************************************************************************/
BTA_API void BTA_AvkProtectReq(tBTA_AVK_HNDL hndl, UINT8 *p_data, UINT16 len);
...
**
*******************************************************************************/
BTA_API void BTA_AvkProtectRsp(tBTA_AVK_HNDL hndl, UINT8 error_code, 
...
**
*******************************************************************************/
BTA_API void BTA_AvkDelayReport(tBTA_AVK_HNDL hndl, UINT16 delay);

/*******************************************************************************
**
** Function         BTA_AvkAbortReq
**
...
**
*******************************************************************************/
BTA_API void BTA_AvkAbortReq(tBTA_AVK_HNDL hndl);
