...
#define BTA_AV_FEAT_COVER_ART   0x4000  /* cover art */
...
typedef UINT8 tBTA_CAS_IMG_HDL_STR[BIP_IMG_HANDLE_SIZE+1];  /* image handle */
typedef UINT8 tBTA_CAS_FNAME_STR[BIP_FNAME_SIZE+1];         /* friendly name */
#endif
...
/*****************************************************************************
** Cover Art Server definition
*****************************************************************************/
/* definition from BIP */
typedef tBIP_IMAGE_DESC         tBTA_AV_CA_IMAGE_DESC;
typedef tBIP_IMG_HDL_STR        tBTA_AV_CA_IMG_HDL;
typedef tBIP_IMAGE_HDL_DESC     tBTA_AV_CA_IMG_HDL_DESC;
typedef tBIP_IMAGE_LIST_ELM     tBTA_AV_CA_IMG_LIST_ELM;
typedef tBIP_IMAGING_CAPS       tBTA_AV_CA_IMG_CAPS;
typedef tBIP_IMAGE_PROPERTIES   tBTA_AV_CA_IMG_PROPERTIES;
typedef tBIP_SDP_PARAMS         tBTA_AV_CA_SDP_PARAMS;
typedef tBIP_GET_IMG_REQ_EVT    tBTA_AV_CA_IMG_REQ_EVT;

/* response code definition */
#define BTA_AV_CAS_RSP_OK                   OBX_RSP_OK                 /* 0x20 OK, Success */
#define BTA_AV_CAS_RSP_BAD_REQUEST          OBX_RSP_BAD_REQUEST        /* 0x40 Bad Request - server couldn't understand request */
#define BTA_AV_CAS_RSP_UNAUTHORIZED         OBX_RSP_UNAUTHORIZED       /* 0x41 Unauthorized */
#define BTA_AV_CAS_RSP_FORBIDDEN            OBX_RSP_FORBIDDEN          /* 0x43 Forbidden - operation is understood but refused */
#define BTA_AV_CAS_RSP_NOT_FOUND            OBX_RSP_NOT_FOUND          /* 0x44 Not Found */
#define BTA_AV_CAS_RSP_NOT_ACCEPTABLE       OBX_RSP_NOT_ACCEPTABLE     /* 0x46 Not Acceptable */
#define BTA_AV_CAS_RSP_PRECONDTN_FAILED     OBX_RSP_PRECONDTN_FAILED   /* 0x4C Precondition failed */
#define BTA_AV_CAS_RSP_NOT_IMPLEMENTED      OBX_RSP_NOT_IMPLEMENTED    /* 0x51 Not Implemented */
#define BTA_AV_CAS_RSP_SERVICE_UNAVL        OBX_RSP_SERVICE_UNAVL      /* 0x53 Service Unavailable */
typedef tOBX_RSP_CODE   tBTA_AV_CAS_RSP;

/* Server callback function event */
#define BTA_AV_CAS_ENABLE_EVT          BTA_BIS_ENABLE_EVT      /* Cover Art server is enabled. */
#define BTA_AV_CAS_OPEN_EVT            BTA_BIS_OPEN_EVT        /* Connection to peer is open. */
#define BTA_AV_CAS_DISC_EVT            BTA_BIS_DISC_EVT        /* OBEX Connection to peer closed. */
#define BTA_AV_CAS_CLOSE_EVT           BTA_BIS_CLOSE_EVT       /* Transport connection to peer closed. */
#define BTA_AV_CAS_PROGRESS_EVT        BTA_BIS_PROGRESS_EVT    /* Push/pull in progres */
#define BTA_AV_CAS_GET_PROP_EVT        BTA_BIS_GET_PROP_EVT    /* client requests for image properties */
#define BTA_AV_CAS_GET_IMAGE_EVT       BTA_BIS_GET_IMAGE_EVT   /* client requests for an image  */
#define BTA_AV_CAS_GET_THUMB_EVT       BTA_BIS_GET_THUMB_EVT   /* client requests for the image thumbnail */

typedef UINT8 tBTA_AV_CAS_EVT;

typedef tBTA_BIS tBTA_AV_CAS;

/* AV Cover Art callback */
typedef void (tBTA_AV_CAS_CBACK)(tBTA_AV_CAS_EVT event, tBTA_AV_CAS *p_data);
...
/*******************************************************************************
**
** Function         BTA_AvCoverArtEnableServer
**
** Description      This function is called to enable AVRC cover art server.
**                  Note the (client)controller role is registered in RC.
**
**                  sec_mask:   Cover art security mask
...
**
*******************************************************************************/
BTA_API void BTA_AvCoverArtEnableServer(tBTA_SEC sec_mask, tBTA_AV_CAS_CBACK *p_cback,
                                        UINT8 app_id);

/*******************************************************************************
**
** Function         BTA_AvCoverArtDisableServer
**
** Description      This function is called to disable AVRC cover art server.
**                  Note the (client)controller role is deregistered in RC.
**
** Returns          void
**
*******************************************************************************/
BTA_API void BTA_AvCoverArtDisableServer(void);

/*******************************************************************************
**
** Function         BTA_AvCoverArtImagePropertiesRsp
**
...
**
**                  rsp:    OBEX response code
**                  p_prop: Properties to return
**
** Returns          void
**
*******************************************************************************/
BTA_API extern void BTA_AvCoverArtImagePropertiesRsp(tBTA_AV_CAS_RSP rsp,
                                                     tBTA_AV_CA_IMG_PROPERTIES *p_prop);


/*******************************************************************************
**
** Function         BTA_AvCoverArtGetImageRsp
**
** Description      When the application receives BTA_AV_CAS_GET_IMAGE_EVT, this
**                  function is used to send the response to the connected client.
**
**                  rsp:    OBEX response code
**                  p_name: Full path for the image
**
** Returns          void
**
*******************************************************************************/
BTA_API extern void BTA_AvCoverArtGetImageRsp(tBTA_AV_CAS_RSP rsp_code,
                                              UINT8 *p_name);

/*******************************************************************************
**
** Function         BTA_AvCoverArtGetThumbRsp
**
** Description      When the application receives BTA_AV_CAS_GET_THUMB_EVT, this
**                  function is used to send the response to the connected client.
**
**                  rsp:    OBEX response code
**                  p_name: Full path for the thumbnail
**
** Returns          void
**
*******************************************************************************/
BTA_API extern void BTA_AvCoverArtGetThumbRsp(tBTA_AV_CAS_RSP rsp_code,
                                              UINT8 *p_name);
