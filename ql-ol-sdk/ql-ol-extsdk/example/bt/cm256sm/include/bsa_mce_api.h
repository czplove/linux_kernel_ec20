...
tBSA_STATUS BSA_MceMnCloseInit(tBSA_MCE_MN_CLOSE *p_close);

/*******************************************************************************
**
** Function         BSA_MceMnClose
**
** Description      Close the current connection to the MAP client. Aborts any
**                  active MAP transfer.
**
** Returns          tBSA_STATUS
**
...
tBSA_STATUS BSA_MceMnClose(tBSA_MCE_MN_CLOSE *p_close);
