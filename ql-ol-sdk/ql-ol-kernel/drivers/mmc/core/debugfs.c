...
#if 1 //add by carl for dynamic set max clock by "echo 50000000 > /sys/kernel/debug/mmc0/max_clock"
	else if (host->card == NULL && (freq == 25*1000000 || freq == 50*1000000 || freq == 100*1000000 || freq == 200*1000000) && freq < host->f_max) {
            host->f_max = freq;
		err = 0;
       }
#endif
