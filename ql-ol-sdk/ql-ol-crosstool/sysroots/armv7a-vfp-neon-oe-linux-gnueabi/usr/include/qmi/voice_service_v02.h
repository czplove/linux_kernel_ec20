...
#define VOICE_V02_IDL_MINOR_VERS 0x4B
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define VOICE_V02_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define VOICE_V02_MAX_MESSAGE_ID 0x006C
/**
    @}
  */
 ...
 */
  ...
  */
  ...
  uint8_t call_pull;
  /**<   Call being pulled from a secondary device. Values: \n
       - 0x00 -- FALSE \n
       - 0x01 -- TRUE
  */
...
typedef struct {
  ...
  */
  ...
  /**<   TRUE: connected number has come as a result of ECT
       FALSE: connected number has not as a result of ECT
  */
 ...
 */
  ...
  /**<   ECT Consultative Call ID.
       Used only in case of Consultative Transfer
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Indication Message; Informs clients about VICE(Volte over Internet Connected Endpoint) dialog event */
typedef struct {
