...
**
**  Copyright (c) 2006-2016, Broadcom Corp., All Rights Reserved.
...
/* CoverArt. This bit is set if the player supports cover art command. */
#define AVRC_PF_COVER_ART_BIT_NO    68
#define AVRC_PF_COVER_ART_MASK      0x10
#define AVRC_PF_COVER_ART_OFF       8
#define AVRC_PF_COVER_ART_SUPPORTED(x) ((x)[AVRC_PF_COVER_ART_OFF] & AVRC_PF_COVER_ART_MASK)
