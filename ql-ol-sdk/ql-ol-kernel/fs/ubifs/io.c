...
out:
	if (!quiet) {
		...
		//ռ˳Linuxsystemʱ ubi 0 һ£modem ubi سҲ
			...
			{
				printk("@Ramos set restore recoveryfs flag here 6661111  vi.dev_num=%d, vi.vol_id=%d , \r\n",  (c)->vi.ubi_num,(c)->vi.vol_id);
				Quectel_Set_Partition_RestoreFlag("recoveryfs",6);
			}
		}
#endif		
	}
...
out:
	...
	//ռ˳Linuxsystemʱ ubi 0 һ£modem ubi سҲ
		...
		{
			printk("@Ramos set restore recoveryfs flag here 6662222 vi.dev_num=%d, vi.vol_id=%d , \r\n", (c)->vi.ubi_num,(c)->vi.vol_id);
			Quectel_Set_Partition_RestoreFlag("recoveryfs",6);
		}
	}
#endif	
...
out:
	...
	//ռ˳Linuxsystemʱ ubi 0 һ£modem ubi سҲ
			...
			{
				printk("@Ramos set restore recoveryfs flag here 6663333vi.dev_num=%d, vi.vol_id=%d , \r\n", (c)->vi.ubi_num,(c)->vi.vol_id);
				Quectel_Set_Partition_RestoreFlag("recoveryfs",6);
			}
		}
#endif	
