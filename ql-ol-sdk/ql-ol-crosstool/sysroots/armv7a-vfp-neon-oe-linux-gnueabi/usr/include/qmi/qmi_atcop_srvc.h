...
typedef enum
{
  QMI_ATCOP_URC_PORT_INVALID = 0xff,     // forwarding to all port
  QMI_ATCOP_URC_PORT_ALL = 0,            // forwarding to the port configured by cmd:AT+QURCCFG="urcport","xxxx"
  QMI_ATCOP_URC_PORT_UART1 = 1,          // forwarding to MAIN UART(DS3G_SIOLIB_UART1_PORT)
  QMI_ATCOP_URC_PORT_USBAT = 2,          // forwarding to DS3G_SIOLIB_SMD_DATA11_PORT
  QMI_ATCOP_URC_PORT_USBMODEM = 3        // forwarding to DS3G_SIOLIB_SMD_DS_PORT
