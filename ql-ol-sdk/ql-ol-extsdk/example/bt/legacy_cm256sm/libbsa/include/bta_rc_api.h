...
**                  used instead.
**
**  Copyright (c) 2013-2016, Broadcom Corp., All Rights Reserved.
...
#define BTA_RC_FEAT_COVER_ART       0x0020  /* cover art support */
#define BTA_RC_FEAT_INT             0x0040  /* initiator */
#define BTA_RC_FEAT_ACP             0x0080  /* acceptor */
...
#define BTA_RC_BROWSE_CONNECTED_EVT     7       /* AVRC browse channel connected */
#define BTA_RC_BROWSE_DISCONNECTED_EVT  8       /* AVRC browse channel disconnected */

/* Event definitons for tBTA_RC_CBACK (CT events) */
#define BTA_RC_UNIT_INFO_RSP_EVT        9       /* Received response for UNIT INFO command */
#define BTA_RC_SUBUNIT_INFO_RSP_EVT     10      /* Received response for SUBUNIT INFO command */
#define BTA_RC_PASS_THRU_RSP_EVT        11      /* Received response for PASSTHROUGH command */
#define BTA_RC_VENDOR_RSP_EVT           12      /* Received response for VENDOR DEPENDENT command */
#define BTA_RC_METADATA_RSP_EVT         13      /* Received response for METADATA command */
#define BTA_RC_BROWSE_RSP_EVT           14      /* Received response for BROWSING command */
#define BTA_RC_CMD_TOUT_EVT             15      /* Timeout waiting for command response */

/* Event definitons for tBTA_RC_CBACK (TG events) */
#define BTA_RC_UNIT_INFO_CMD_EVT        16      /* Received UNIT INFO command */
#define BTA_RC_SUBUNIT_INFO_CMD_EVT     17      /* Received SUBUNIT INFO command */
#define BTA_RC_PASS_THRU_CMD_EVT        18      /* Received PASSTHROUGH command */
#define BTA_RC_VENDOR_CMD_EVT           19      /* Received VENDOR DEPENDENT command */
#define BTA_RC_METADATA_CMD_EVT         20      /* Received PASS THROUGH command */
#define BTA_RC_BROWSE_CMD_EVT           21      /* Received BROWSING command */

#define BTA_RC_PEER_FEAT_EVT            22      /* Peer features notification (sdp results for peer initiated AVRC connection) */
...
/* AVRC channel type is open */
#define BTA_RC_IS_OPEN_TYPE_CONTROL     0x0001
#define BTA_RC_IS_OPEN_TYPE_BROWSE      0x0002

typedef UINT16  tBTA_RC_IS_OPEN_TYPE;
...
typedef struct
{
    tBTA_STATUS         rc_status;
    BD_ADDR             bd_addr;
    tBTA_RC_PEER_FEAT   peer_feat;
} tBTA_RC_CONNECTED;

/* Data for BTA_RC_DISCONNECTED_EVT */
typedef struct
{
    tBTA_STATUS             status;
    tBTA_RC_IS_OPEN_TYPE    open_type;
} tBTA_RC_DISCONNECTED;
...
typedef union
{
    tBTA_STATUS                 status;             /* BTA_RC_ENABLE_EVT, BTA_RC_DISABLE_EVT,
                                                       BTA_RC_BROWSE_CONNECTED_EVT,
                                                       BTA_RC_BROWSE_DISCONNECTED_EVT */
    tBTA_RC_CONNECTED           connected;          /* BTA_RC_CONNECTED_EVT */
    tBTA_RC_DISCONNECTED        disconnected;       /* BTA_RC_DISCONNECTED_EVT */
...
*****************************************************************************/
/* Reserved value for invalid bta_rc_cac handle */
#define BTA_RC_CAC_INVALID_HANDLE   0xFF

/* Defination for BIP */
typedef tBIP_IMG_HDL_STR        tBTA_RC_IMG_HDL;
typedef tBIP_IMAGE_DESC         tBTA_RC_IMG_DESC;

/*****************************************************************************
** Client definition
*****************************************************************************/
/* Client callback function event */
#define BTA_RC_CAC_ENABLE_EVT          BTA_BIC_REGISTER_EVT    /* Cover art client is enabled. */
#define BTA_RC_CAC_OPEN_EVT            BTA_BIC_OPEN_EVT        /* Connection to peer is open. */
#define BTA_RC_CAC_CLOSE_EVT           BTA_BIC_CLOSE_EVT       /* Connection to peer closed. */
#define BTA_RC_CAC_PROGRESS_EVT        BTA_BIC_PROGRESS_EVT    /* Push/pull in progres */
#define BTA_RC_CAC_PROPERTIES_EVT      BTA_BIC_PROPERTIES_EVT  /* Image properties */
#define BTA_RC_CAC_GET_IMAGE_EVT       BTA_BIC_GET_IMAGE_EVT   /* Get Image  */
#define BTA_RC_CAC_GET_THUMB_EVT       BTA_BIC_GET_THUMB_EVT   /* Get Image thumbnail */
#define BTA_RC_CAC_ABORT_EVT           BTA_BIC_ABORT_EVT       /* Abort response */
#define BTA_RC_CAC_ERROR_EVT           BTA_BIC_ERROR_EVT       /* Error */

typedef UINT8 tBTA_RC_CAC_EVT;

/* Union of all client callback structures */
typedef tBTA_BIC tBTA_RC_CAC;

/* callback function */
typedef void (tBTA_RC_CAC_CBACK)(tBTA_RC_CAC_EVT event, tBTA_BI_HANDLE bi_handle, tBTA_RC_CAC *p_data);
#endif
...
**
** Description      Open an AVRCP control channel as initiator. After AVRC control
**                  channel is opened, if both sides support browse, open an AVRC
**                  browse channel as initiator as well.
**
**
**                  Role may be controller (BTA_RC_FEAT_CONTROL) or
**                  target (BTA_RC_FEAT_TARGET) or both.
**                  BTA_RC_CONNECTED_EVT will report the status of the operation.
**                  BTA_RC_BROWSE_CONNECTED_EVT will be sent to the upper layer if
**                  browse channel is opened
**
**
** Returns          void
**
...
/*******************************************************************************
**
** Function         BTA_RcCoverArtEnableClient
**
** Description      This function is called to enable AVRC cover art client.
**                  Note the (server)target role is registered in AV.
**
**                  p_cback: Cover art client callback
**                  app_id  : Cover art client application ID
**
** Returns          void
**
*******************************************************************************/
BTA_API void BTA_RcCoverArtEnableClient(tBTA_RC_CAC_CBACK *p_cback, UINT8 app_id);

/*******************************************************************************
**
** Function         BTA_RcCoverArtRegisterClient
**
** Description      This function is called to register AVRC cover art client.
**                  Note the (server)target role is registered in AV.
**
**                  cac_index : Cover art client index to register
**                  app_id: Cover art client application ID
**
** Returns          void
**
*******************************************************************************/
BTA_API void BTA_RcCoverArtRegisterClient(UINT8 cac_index, UINT8 app_id);

/*******************************************************************************
**
** Function         BTA_RcCoverArtDisableClient
**
** Description      This function is called to disable AVRC cover art client.
**                  Note the (server)target role is deregistered in AV.
**                  If there is an active connection, close the connection then
**                  deregsiter cover art.
**
**                  cac_handle: Cover art client handle
**
** Returns          void
**
*******************************************************************************/
BTA_API void BTA_RcCoverArtDisableClient(void);

/*******************************************************************************
**
** Function         BTA_RcCoverArtOpen
**
** Description      Open Cover Art Connection.
**
**                  This function can only be used if RC is enabled with feature
**                  BTA_RC_FEAT_COVER_ART.
**
**                  handle:     AVRC handle
...
**
*******************************************************************************/
BTA_API void BTA_RcCoverArtOpen(UINT8 handle, tBTA_SEC sec_mask);

/*******************************************************************************
**
** Function         BTA_RcCoverArtClose
**
** Description      Close Cover Art Connection.
**
**                  This function can only be used if RC is enabled with feature
**                  BTA_RC_FEAT_COVER_ART.
**
...
**
*******************************************************************************/
BTA_API void BTA_RcCoverArtClose(UINT8 cac_handle);

/*******************************************************************************
**
** Function         BTA_RcCoverArtGetImageProperties
**
...
**
**                  cac_handle: Cover art client handle
**                  img_hdl: Handle for the image to retrive
**
** Returns          void
**
*******************************************************************************/
BTA_API void BTA_RcCoverArtGetImageProperties(UINT8 cac_handle, tBTA_RC_IMG_HDL img_hdl);

/*******************************************************************************
**
** Function         BTA_RcCoverArtGetImage
**
...
**                  cac_handle: Cover art client handle
**                  img_hdl:    Handle for the image to retrive
**                  p_path:     Path to save the retrived image
**                  p_param:    Parameters related to get image
**
** Returns          void
**
*******************************************************************************/
BTA_API void BTA_RcCoverArtGetImage(UINT8 cac_handle, tBTA_RC_IMG_HDL img_hdl,
                                    UINT8 *p_path, tBIP_IMAGE_DESC *p_param);

/*******************************************************************************
**
** Function         BTA_RcCoverArtGetThumbnail
**
...
**
*******************************************************************************/
BTA_API void BTA_RcCoverArtGetThumbnail(UINT8 cac_handle, tBTA_RC_IMG_HDL img_hdl,
                                    UINT8 *p_path);

/*******************************************************************************
**
** Function         BTA_RcCoverArtAbort
**
** Description      Abort current obex operation
**
**                  This function can only be used if RC is enabled with feature
**                  BTA_RC_FEAT_COVER_ART.
**
...
**
*******************************************************************************/
BTA_API void BTA_RcCoverArtAbort(UINT8 cac_handle);
#endif
