...
#define BTA_OP_VCAL_JOURNAL         2       /* Object is a "Journal" object */
...
/* vCal Property Names */
#define BTA_OP_VCAL_ATTACHMENT      1       /* Attachement */
#define BTA_OP_VCAL_CATEGORIES      2       /* Categories of event. */
#define BTA_OP_VCAL_CLASSIFICATION  3      /* Classification */
#define BTA_OP_VCAL_COMMENT         4      /* Comment */
#define BTA_OP_VCAL_DESCRIPTION     5       /* Description of event. */
#define BTA_OP_VCAL_GEO_LOCATION    6       /* Geographic location. */
#define BTA_OP_VCAL_LOCATION        7       /* Location of event. */
#define BTA_OP_VCAL_PER_COMPLETE    8       /* Percent complete. */
#define BTA_OP_VCAL_PRIORITY        9       /* Priority of event. */
#define BTA_OP_VCAL_RESOURCES       10       /* Resources. */
#define BTA_OP_VCAL_STATUS          11       /* Status of event. */
#define BTA_OP_VCAL_SUMMARY         12      /* Summary of event. */
#define BTA_OP_VCAL_COMPLETED       13       /* Date-Time completed. */
#define BTA_OP_VCAL_DTEND           14       /* Date-Time end. */
#define BTA_OP_VCAL_DUE             15       /* Date-Time due. */
#define BTA_OP_VCAL_DTSTART         16       /* Date-Time start. */
#define BTA_OP_VCAL_DURATION        17      /* Duration. */
#define BTA_OP_VCAL_FREE_BUSY       18       /* Free/Busy time. */
#define BTA_OP_VCAL_TZID            19       /* Time zone id. */
#define BTA_OP_VCAL_TZNAME          20       /* Time zone name. */
#define BTA_OP_VCAL_TZOFFSETFROM    21       /* Time zone offset from. */
#define BTA_OP_VCAL_TZOFFSETTO      22      /* Time zone offset to. */
#define BTA_OP_VCAL_TZURL           23       /* Time zone URL. */
#define BTA_OP_VCAL_ATTENDEE        24       /* Attendee. */
#define BTA_OP_VCAL_CONTACT         25       /* Contact */
#define BTA_OP_VCAL_ORGANIZER       26      /* Organizer */
#define BTA_OP_VCAL_RECURRENCE_ID   27      /* Recurrence ID */
#define BTA_OP_VCAL_RELATED_TO      28      /* Related To */
#define BTA_OP_VCAL_URL             29      /* URL */
#define BTA_OP_VCAL_UID             30      /* Unique Identifier */
#define BTA_OP_VCAL_EXDATE          31      /* Exception data-times */
#define BTA_OP_VCAL_RDATE           32      /* Recurrence Date-Times */
#define BTA_OP_VCAL_RRULE           33      /* Recurrence Rule */
#define BTA_OP_VCAL_ACTION          34      /* Action */
#define BTA_OP_VCAL_REPEAT          35      /* Repeat Count */
#define BTA_OP_VCAL_TRIGGER         36      /* Trigger */
#define BTA_OP_VCAL_CREATED         37      /* Date-Time Created */
#define BTA_OP_VCAL_DTSTAMP         38      /* Date-Time Stamp */
#define BTA_OP_VCAL_LAST_MODIFIED   39      /* Last Modified */
#define BTA_OP_VCAL_SEQUENCE        40      /* Sequence Number */
#define BTA_OP_VCAL_LUID            41      /* Locally Unique Identifier. */

#define BTA_OP_MAX_VCAL             BTA_OP_VCAL_LUID   /* Need to update it accordingly */
...
#define BTA_OPC_RSP_FORBIDDEN  5   /* Operation forbidden */
#define BTA_OPC_RSP_NOT_ACCEPTABLE  6  /* Operation not acceptable */
...
#define BTA_OPS_DISABLE_EVT         6   /* Object push server is disabled.*/
...
**
** Description      Parse a vCard 2.1 or 3.0 object.  The input to this function is
