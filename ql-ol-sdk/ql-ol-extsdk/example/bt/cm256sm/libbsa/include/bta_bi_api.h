...
#define BTA_BIC_MAX_REG         BTA_BIC_MAX_CONN
#define BTA_BIC_INVALID_HANDLE  (0xFF)
...
#define BTA_BIC_ERROR_EVT           16   /* Error */
...
#define BTA_BIS_DISC_EVT            0x12 /* OBEX disconnected */
#define BTA_BIS_CLOSE_EVT           0x13 /* Connection to peer closed. */
#define BTA_BIS_PROGRESS_EVT        0x14 /* Number of bytes read or written so far */
#define BTA_BIS_GET_PART_EVT        0x15 /* responder requests for partial image (for printing /w DPOF only) */
#define BTA_BIS_GET_LIST_EVT        0x16 /* client requests for images listing */
#define BTA_BIS_GET_PROP_EVT        0x17 /* client requests for image properties */
#define BTA_BIS_GET_IMAGE_EVT       0x18 /* client requests for an image  */
#define BTA_BIS_GET_THUMB_EVT       0x19 /* client requests for the image thumbnail */
#define BTA_BIS_GET_ATTACH_EVT      0x1A /* client requests for the image attachment */
#define BTA_BIS_GET_MONITOR_EVT     0x1B /* client requests for the monitoring image (for remote camera only) */
#define BTA_BIS_DEL_IMAGE_EVT       0x1C /* client requests to delete an image */
#define BTA_BIS_PUT_IMAGE_EVT       0x1D /* client requests to put an image */
#define BTA_BIS_PUT_THUMB_EVT       0x1E /* client requests to put an image thumbnail */
#define BTA_BIS_PUT_ATTACH_EVT      0x1F /* client requests to put an image attachment */
...
typedef UINT8 tBTA_BI_HANDLE;

typedef struct
{
    UINT8           app_id;     /* ID associated with call to BTA_BicRegister() */
...
typedef struct
{
    UINT8               *desc;    /* The reason of the Error */
    tBIP_STATUS         status;
} tBTA_BI_ERROR_EVT;
...
typedef union
{
    tBTA_BIC_REGIST_EVT     reg;    /* BTA_BIC_REGISTER_EVT */
    tBTA_BI_PROGRESS        prog;   /* BTA_BIC_PROGRESS_EVT */
    tBTA_BIC_OPEN           open;   /* BTA_BIC_OPEN_EVT */
    tBTA_BIC_CLOSE          close;  /* BTA_BIC_CLOSE_EVT */
    ...
    tBTA_BI_ERROR_EVT       err;    /* BTA_BIC_ERROR_EVT */
} tBTA_BIC;


/* Client callback function */
typedef void (tBTA_BIC_CBACK)(tBTA_BIC_EVT event, UINT8 handle, tBTA_BIC *p_data);
...
**
*******************************************************************************/
BTA_API extern void BTA_BisGetObjRsp(tBTA_BI_HANDLE bi_handle, UINT8 handle,
                                     UINT8 bip_op, tOBX_RSP_CODE rsp_code,
                                     UINT8 *p_name);
...
**
*******************************************************************************/
BTA_API extern void BTA_BisPartialImageRsp(tBTA_BI_HANDLE bi_handle,
                        UINT8 handle, tOBX_RSP_CODE rsp_code, UINT8 *p_name);
