...
retry:
	for (p = fs_names; *p; p += strlen(p)+1) {
		...
		{
			printk("@Ramos set restore recoveryfs flag here 111 \r\n");
			Quectel_Set_Partition_RestoreFlag("recoveryfs",1);
		}
#endif
	...
	__bdevname(ROOT_DEV, b);
		...
		{
			printk("@Ramos set restore recoveryfs flag here 222 \r\n");
			Quectel_Set_Partition_RestoreFlag("recoveryfs",2);
		}
#endif
