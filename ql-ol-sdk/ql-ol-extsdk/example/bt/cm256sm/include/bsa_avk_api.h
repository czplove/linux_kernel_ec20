...
#define BSA_RC_FEAT_RCCT      BTA_RC_FEAT_CONTROL       /* remote control controller */
#define BSA_RC_FEAT_RCTG      BTA_RC_FEAT_TARGET        /* remote control target */
#define BSA_RC_FEAT_VENDOR    BTA_RC_FEAT_VENDOR        /* remote control vendor dependent commands */
#define BSA_RC_FEAT_METADATA  BTA_RC_FEAT_METADATA      /* AVRC Metadata transfer supported */
#define BSA_RC_FEAT_BROWSE    BTA_RC_FEAT_BROWSE        /* browsing channel support */
#define BSA_RC_FEAT_COVER_ART BTA_RC_FEAT_COVER_ART     /* cover art channel support */
...
/* AV callback events */
#define BSA_AVK_REGISTER_EVT     1       /* AVK registered */
...
#define BSA_AVK_CAC_ENABLE_EVT              39      /* Cover Art client enabled. */
#define BSA_AVK_CAC_OPEN_EVT                40      /* Cover Art connection opened */
#define BSA_AVK_CAC_CLOSE_EVT               41      /* Cover Art connection closed */
#define BSA_AVK_CAC_PROPERTIES_EVT          42      /* Cover Art get imge properties response */
#define BSA_AVK_CAC_PROGRESS_EVT            43      /* Cover Art number of bytes read or written */
#define BSA_AVK_CAC_GET_IMAGE_EVT           44      /* Cover Art get image response */
#define BSA_AVK_CAC_GET_THUMB_EVT           45      /* Cover Art get thumbnail response */
#define BSA_AVK_CAC_ABORT_EVT               46      /* Cover Art abort response */
#define BSA_AVK_CAC_ERROR_EVT               47      /* Cover Art internal error */
#endif
...
#if (defined(AVRC_COVER_ART_INCLUDED) && AVRC_COVER_ART_INCLUDED == TRUE)
#define BSA_MAX_BIC_CONNECTIONS    BTA_BIC_MAX_CONN
#define BSA_AVK_CAC_MAX_PATH_LEN 512

#ifndef BSA_AVK_MAX_NUM_VARIANT
#define BSA_AVK_MAX_NUM_VARIANT     3
#endif

typedef tBTA_RC_IMG_HDL tBSA_AVK_RC_CAC_IMG_HDL;
typedef tBTA_RC_IMG_DESC tBSA_AVK_RC_CAC_IMAGE_DESC;
...
/* AVK Delay Report status */
/* data associated with BSA_AVK_DELAY_RPT_EVT */
typedef struct
{
    tBSA_STATUS status;
    BD_ADDR     bd_addr;
} tBSA_AVK_DELAY_RPT_MSG;
...
#if (defined(AVRC_COVER_ART_INCLUDED) && AVRC_COVER_ART_INCLUDED == TRUE)
/* data associated with BSA_AvkOpenCoverArt */
typedef struct
{
    BD_ADDR         bd_addr;
    tBSA_SEC_AUTH   auth;
...
/* data associated with BSA_AvkCacGetProp */
typedef struct
{
    UINT8                   rc_handle;
    tBSA_AVK_RC_CAC_IMG_HDL img_handle;
} tBSA_AVK_CAC_GET_PROP;

/* data associated with BSA_AvkCacGetImg */
typedef struct
{
    UINT8                       rc_handle;
    tBSA_AVK_RC_CAC_IMG_HDL     img_handle;
    tBSA_AVK_RC_CAC_IMAGE_DESC  desc;
    UINT16                      path_len;
    UINT8                       path[BSA_AVK_CAC_MAX_PATH_LEN];
} tBSA_AVK_CAC_GET_IMG;

/* data associated with BSA_AvkCacGetThumb */
typedef struct
{
    UINT8                       rc_handle;
    tBSA_AVK_RC_CAC_IMG_HDL     img_handle;
    UINT16                      path_len;
    UINT8                       path[BSA_AVK_CAC_MAX_PATH_LEN];
} tBSA_AVK_CAC_GET_THUMB;

/* data associated with BSA_AvkCacAbort */
typedef struct
{
    UINT8                   rc_handle;
} tBSA_AVK_CAC_ABORT;
...
#define BSA_AVK_ELEMENT_ATTR_MAX 8
...
{
    tBSA_STATUS     status;
} tBSA_AVK_OPEN_CAC_CMD_RSP;

typedef struct
{
    tBSA_STATUS     status;
}tBSA_AVK_CAC_ENABLE_EVT;

typedef struct
{
    BD_ADDR         bd_addr;       /* Bluetooth address of the connected device */
    tBSA_STATUS     status;
} tBSA_AVK_OPEN_CAC_EVT;

typedef struct
{
    BD_ADDR         bd_addr;       /* Bluetooth address of the connected device */
    tBSA_STATUS     status;
} tBSA_AVK_CLOSE_CAC_EVT;

typedef struct
{
    tBSA_STATUS     status;
} tBSA_AVK_CLOSE_CAC_CMD_RSP;

typedef struct
{
    tBSA_STATUS     status;
} tBSA_AVK_CAC_GET_PROP_CMD_RSP;

typedef struct
{
    tBSA_STATUS         status;
    /* if native is not present (in other chunk of object): encoding is 0 str */
    tBIP_IMAGE_FORMAT   native;
    tBIP_IMAGE_DESC     variant[BSA_AVK_MAX_NUM_VARIANT];
...
typedef union
{
    ...
    tBSA_AVK_DELAY_RPT_MSG delay_rpt_rsp;
...
#if (defined(AVRC_COVER_ART_INCLUDED) && AVRC_COVER_ART_INCLUDED == TRUE)
    tBSA_AVK_CAC_ENABLE_EVT             cac_enable_evt;
    tBSA_AVK_OPEN_CAC_EVT               cac_open_evt;
    tBSA_AVK_CLOSE_CAC_EVT              cac_close_evt;
    tBSA_AVK_CAC_GET_PROP_EVT           cac_prop_evt;
    tBSA_AVK_CAC_PROGRESS_EVT           cac_prog_evt;
    tBSA_AVK_CAC_GET_IMG_EVT            cac_get_img_evt;
    tBSA_AVK_CAC_GET_THUMB_EVT          cac_get_thumb_evt;
    tBSA_AVK_CAC_ABORT_EVT              cac_abort_evt;
    tBSA_AVK_CAC_ERROR_EVT              cac_error_evt;
#endif
} tBSA_AVK_MSG;
...
/* data associated with BSA_AvkSelectStreamingDev */
typedef struct
{
    BD_ADDR bd_addr;
} tBSA_AVK_SELECT_STREAM_DEV;
...
/* data associated with BSA_AvkAbortReq */
typedef struct
{
    BD_ADDR bd_addr;
} tBSA_AVK_ABORT_REQ;
...
/*******************************************************************************
 **
 ** Function         BSA_AvkSelectStreamDevInit
 **
 ** Description     Init structure tBSA_AVK_SELECT_STREAM_DEV
 **                      to be used with BSA_AvkSelectStreamDevInit
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkSelectStreamDevInit(tBSA_AVK_SELECT_STREAM_DEV *p_select);

/*******************************************************************************
 **
 ** Function         BSA_AvkSelectStreamDev
 **
 ** Description     Select the current streaming device
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkSelectStreamDev(tBSA_AVK_SELECT_STREAM_DEV *p_select);
...
**                  be used if AVK is enabled with feature BSA_RC_FEAT_RCCT.
**
** Returns          tBSA_STATUS
**
*******************************************************************************/
...
**
** Description      Send a remote control command.  This function can only
**                  be used if AVK is enabled with feature BSA_RC_FEAT_METADATA.
**
** Returns          tBSA_STATUS
**
*******************************************************************************/
...
/*******************************************************************************
**
** Function         BSA_AvkAbortReqInit
**
** Description      Init structure tBSA_AVK_ABORT_REQ
**
** Returns          tBSA_STATUS
**
*******************************************************************************/
tBSA_STATUS BSA_AvkAbortReqInit(tBSA_AVK_ABORT_REQ *pAbortReq);

/*******************************************************************************
**
** Function         BSA_AvkAbortReq
**
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkAbortReq(tBSA_AVK_ABORT_REQ *pAbortReq);
 ...
 ** Function         BSA_AvkOpenRcInit
 **
 ** Description      Init structure tBSA_AVK_OPEN_CAC to be used with BSA_AvkOpenCoverArt
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkOpenCoverArtInit(tBSA_AVK_OPEN_CAC * p_open_cac);

/*******************************************************************************
 **
 ** Function         BSA_AvkOpenCoverArt
 **
 ** Description      Opens an avrcp cover art client connection to a peer device.
 **                  AVK RC must already be connected.
 **                  When connection is open callback function is called
 **                  with a BSA_AVK_OPEN_CAC_EVT.
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkOpenCoverArt(tBSA_AVK_OPEN_CAC * p_open_cac);

/*******************************************************************************
 **
 ** Function         BSA_AvkCloseCacInit
 **
 ** Description      Init structure tBSA_AVK_CLOSE_CAC to be used with BSA_AvkCloseCac
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkCloseCacInit(tBSA_AVK_CLOSE_CAC *p_close_cac);

/*******************************************************************************
 **
 ** Function         BSA_AvkCloseCac
 **
 ** Description      Close an Cover Art client connection
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkCloseCac(tBSA_AVK_CLOSE_CAC *p_close_cac);

/*******************************************************************************
 **
 ** Function         BSA_AvkCacGetPropInit
 **
 ** Description      Init structure tBSA_AVK_CAC_GET_PROP to be used with BSA_AvkCacGetProp
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkCacGetPropInit(tBSA_AVK_CAC_GET_PROP * p_cac_get_prop);

/*******************************************************************************
 **
 ** Function         BSA_AvkCacGetProp
 **
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkCacGetProp(tBSA_AVK_CAC_GET_PROP * p_cac_get_prop);


/*******************************************************************************
 **
 ** Function         BSA_AvkCacGetImgInit
 **
 ** Description      Init structure tBSA_AVK_CAC_GET_IMG to be used with BSA_AvkCacGetImg
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkCacGetImgInit(tBSA_AVK_CAC_GET_IMG * p_cac_get_img);
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkCacGetImg(tBSA_AVK_CAC_GET_IMG * p_cac_get_img);

/*******************************************************************************
 **
 ** Function         BSA_AvkCacGetThumbInit
 **
 ** Description      Init structure tBSA_AVK_CAC_GET_THUMB to be used with BSA_AvkCacGetThumb
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkCacGetThumbInit(tBSA_AVK_CAC_GET_THUMB * p_cac_get_thumb);
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkCacGetThumb(tBSA_AVK_CAC_GET_THUMB * p_cac_get_thumb);

/*******************************************************************************
 **
 ** Function         BSA_AvkCacAbort
 **
 ** Description      Abort Cover Art
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkCacAbort(tBSA_AVK_CAC_ABORT * p_cac_abort);

/*******************************************************************************
 **
 ** Function         BSA_AvkCacAbortInit
 **
 ** Description      Init structure tBSA_AVK_CAC_ABORT to be used with BSA_AvkCacAbort
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkCacAbortInit(tBSA_AVK_CAC_ABORT * p_cac_abort);
