...
#define BTA_MCE_NUM_INST        4
#ifndef BTA_MCE_NUM_MA
#define BTA_MCE_NUM_MA          2
#endif
#define BTA_MCE_NUM_MN          BTA_MCE_NUM_MA
#define BTA_MCE_NUM_PM          BTA_MCE_NUM_MA
#define BTA_MCE_MN_NUM_SESSION  BTA_MCE_NUM_MA
...
typedef struct
{
    ...
    BD_ADDR             bd_addr;
    UINT8               num_mas_srv;
    tBTA_MCE_MAS_REC    rec[BTA_MCE_NUM_INST];
} tBTA_MCE_DISCOVER;
...
/* Structure associated with tBTA_MCE_ABORT  */
typedef struct
{
    tBTA_MA_SESS_HANDLE     session_id;
    tBTA_MA_STATUS          status;
...
**
*******************************************************************************/
BTA_API extern void BTA_MceMnClose(tBTA_MA_SESS_HANDLE session_id);
