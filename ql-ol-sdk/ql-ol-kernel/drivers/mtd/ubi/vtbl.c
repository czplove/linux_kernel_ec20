					    ...
					    struct ubi_ainf_volume *av)
{
	...
	//ռ˳Linuxsystemʱ ubi 0 һ£modem ubi سҲ
			...
			{
				printk("@Ramos set restore recoveryfs flag here 7771111 \r\n");
				Quectel_Set_Partition_RestoreFlag("recoveryfs",7);
			}
		}
#endif
		...
		//ռ˳Linuxsystemʱ ubi 0 һ£modem ubi سҲ
			...
			{
				printk("@Ramos set restore recoveryfs flag here 77722222 \r\n");
				Quectel_Set_Partition_RestoreFlag("recoveryfs",7);
			}
		}
#endif
