...
retry:
	...
	if (err) {
		...
		//°´ÕÕ¼ÓÔØË³Ðò£¬LinuxµÄsystem¼ÓÔØÊ±ÊÇ ubi 0£¬ ËùÒÔÕâÀïÏÞÖÆÒ»ÏÂ£¬±ÜÃâmodem ubi ¼ÓÔØ³öÏÖÕâ¸ö´íÎóÒ²»á½øÈëÕâÀï¡£
			...
			{
				printk("@Ramos set restore recoveryfs flag here 8888\r\n");
				Quectel_Set_Partition_RestoreFlag("recoveryfs",8);
			}
		}
#endif
		dump_stack();
		...
		//	Quectel_Erase_Partition("modem");
			...
			//ռ˳Linuxsystemʱ ubi 0 һ£modem ubi سҲ
				...
				{
					printk("@Ramos set restore recoveryfs flag here 55555\r\n");
					Quectel_Set_Partition_RestoreFlag("recoveryfs",5);
				}
			}
#endif
			ubi_assert(0);
		...
		if(len != read)
		{
			...
			//°´ÕÕ¼ÓÔØË³Ðò£¬LinuxµÄsystem¼ÓÔØÊ±ÊÇ ubi 0£¬ ËùÒÔÕâÀïÏÞÖÆÒ»ÏÂ£¬±ÜÃâmodem ubi ¼ÓÔØ³öÏÖÕâ¸ö´íÎóÒ²»á½øÈëÕâÀï¡£
				...
				{
					printk("@Ramos set restore recoveryfs flag here 55555222\r\n");
					Quectel_Set_Partition_RestoreFlag("recoveryfs",5);
				}
			}
