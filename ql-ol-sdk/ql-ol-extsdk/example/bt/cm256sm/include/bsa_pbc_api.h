...
#define BSA_PBC_REPOSIT_LOCAL      0x01    /* Local PhoneBook */
#define BSA_PBC_REPOSIT_SIM        0x02    /* SIM card PhoneBook */
#define BSA_PBC_REPOSIT_SPEED_DIAL 0x04    /* Speed Dial */
#define BSA_PBC_REPOSIT_FAVORITES  0x08    /* Favorites */

typedef UINT8 tBSA_PBC_SUP_REPOSIT_MASK;
