...
#define BSA_BLE_SEC_AUTH_REQ_SETTING   BTA_LE_AUTH_REQ_SC_MITM_BOND
#else
#define BSA_BLE_SEC_AUTH_REQ_SETTING   BTA_LE_AUTH_REQ_MITM|BTA_LE_AUTH_BOND
#endif
#endif
...
typedef UINT8 tBSA_SEC_LINK_QUALITY_VALUE;
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_SecCloseACLInit(tBSA_SEC_CLOSE_ACL*p_sec_close_acl);

/*******************************************************************************
 **
 ** Function         BSA_SecAddSiDev
 **
 ** Description      Close ACL link
 **
 ** Parameters       Pointer to structure containing API parameters
 **
 ** Returns          Status of the function execution (0=OK or error code)
 **
 *******************************************************************************/
tBSA_STATUS BSA_SecCloseACL(tBSA_SEC_CLOSE_ACL*p_sec_close_acl);
