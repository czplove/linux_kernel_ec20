...
**                  mas_session_id  - MAS session ID
**                  msg_size        - size of message to be written
**                  frac_delv       - fraction delivery used in GetMEssage
...
**                  p_buf       - pointer to the address of the buffer
**                  evt         - event that to be passed into the call-in function
...
**
*******************************************************************************/
BTA_API extern void bta_mce_co_open(UINT8 ccb_idx, const char *p_path, int oflags, UINT32 size, UINT16 evt,
