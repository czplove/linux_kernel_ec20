...
**
**  Copyright (c) 2000-2016, Broadcom Corp., All Rights Reserved.
...
*****************************************************************************/
#define BIP_VERSION_1_0     0x0100
#define BIP_VERSION_1_2     0x0102

#define BIP_VERSION         BIP_VERSION_1_2

#define BIP_MAX_TARGETS         7
...
#define BIP_COVER_ART_UUID  "\x71\x63\xDD\x54\x4A\x7E\x11\xE2\xB4\x7C\x00\x50\xC2\x49\x00\x48"
...
#define BIP_MAX_IR_COVER_ART_FUNCS  0x0001C0
#define BIP_MAX_RR_COVER_ART_FUNCS  0x0001C0
...
enum
{
    ...
    BIP_RP_CLOSE_EVT        = BIP_IS_CLOSE_EVT,       /* 4 Notifies the L2CAP/RFCOMM is closed */
    ...
    BIP_RP_DISC_EVT,        /* 24Notfiies of an OBEX disconnect event */
    BIP_RP_MAX_EVT          /* 25place holder */
};
...
enum
{
    ...
    BIP_RS_GET_ATTACH_EVT   = BIP_IP_GET_ATTACH_EVT,    /* 15Notifies of a GetLinkedAttachment response */
    BIP_RS_GET_PARTIAL_EVT,                             /* 16Notifies of a GetPartialImage response */
    BIP_RS_DISC_EVT,                                    /* 17Notfiies of an OBEX disconnect event */
    BIP_RS_MAX_EVT                                      /* 18place holder */
};
...
enum
{
    ...
    BIP_SERVICE_COVER_ART,  /* 6 */
    BIP_SERVICE_DISPLAY,    /* 7 */
    BIP_SERVICE_REF_OBJ,    /* 8 */
    BIP_SERVICE_ARCH_OBJ,   /* 9 */
    BIP_MAX_SERVICE         /* 10 */
};
...
typedef UINT8  tBIP_CCB_HANDLE; /* Handle used to reference current BIP Connection control block */
...
typedef struct
{
    ...
    tBIP_FNAME_STR          service_name;   /* service name */
    BOOLEAN                 skip_sdp;       /* whether skip add SDP record (for AVRC cover art )*/
} tBIP_SDP_PARAMS;
...
typedef void (tBIP_APP_CBACK)(UINT8        ccb_handle,
                              UINT8        evt,
                              void         *p,          /* in/out */
...
**
*****************************************************************************/
BIP_API extern tBIP_STATUS BIP_Close(tBIP_CCB_HANDLE ccb_handle, tBIP_HANDLE handle);
...
**
*****************************************************************************/
BIP_API extern tBIP_STATUS BIP_GetRequest(tBIP_CCB_HANDLE ccb_handle,
                                          tBIP_HANDLE handle, tBIP_GET_OP op,
                                          void *p_data);
...
**
*****************************************************************************/
BIP_API extern tBIP_STATUS BIP_GetResponse(tBIP_CCB_HANDLE ccb_handle,
                                           tBIP_HANDLE handle, tBIP_GET_OP op,
                                           void *p_data);
...
**
*****************************************************************************/
BIP_API extern tBIP_STATUS BIP_PutRequest(tBIP_CCB_HANDLE ccb_handle,
                                          tBIP_HANDLE handle, tBIP_PUT_OP op,
                                          void *p_data);
...
**
*****************************************************************************/
BIP_API extern tBIP_STATUS BIP_PutResponse(tBIP_CCB_HANDLE ccb_handle,
                                           tBIP_HANDLE handle, tBIP_PUT_OP op,
                                           void *p_data);
...
**
*****************************************************************************/
BIP_API extern tBIP_STATUS BIP_AbortRequest(tBIP_CCB_HANDLE ccb_handle, tBIP_HANDLE handle);
...
**
*****************************************************************************/
BIP_API extern tBIP_STATUS BIP_Auth (tBIP_CCB_HANDLE ccb_handle,
                                          tBIP_HANDLE handle, tBIP_AUTH *p_auth);
...
**
*****************************************************************************/
BIP_API extern tBIP_SERVICE BIP_CheckService(tBIP_CCB_HANDLE ccb_handle, tBIP_HANDLE handle);
...
**
*****************************************************************************/
BIP_API extern tBIP_STATUS BIP_StartInitiator(tBIP_CCB_HANDLE ccb_handle, tBIP_START_IR_MSG *p_msg);
...
**
*****************************************************************************/
BIP_API extern tBIP_STATUS BIP_StopInitiator(tBIP_CCB_HANDLE ccb_handle);
...
**
*****************************************************************************/
BIP_API extern tBIP_STATUS BIP_StartRefService(tBIP_CCB_HANDLE ccb_handle, tBIP_START_REF_MSG *p_msg);
...
**
*****************************************************************************/
BIP_API extern tBIP_STATUS BIP_StopRefService(tBIP_CCB_HANDLE ccb_handle);
...
**
*****************************************************************************/
BIP_API extern tBIP_STATUS BIP_StartResponder(tBIP_CCB_HANDLE ccb_handle, tBIP_START_RP_MSG * p_msg);
...
**
*****************************************************************************/
BIP_API extern tBIP_STATUS BIP_StopResponder(tBIP_CCB_HANDLE ccb_handle);
...
**
*****************************************************************************/
BIP_API extern tBIP_STATUS BIP_ConRefService(tBIP_CCB_HANDLE ccb_handle, tBIP_CON_REF_MSG *p_msg);
...
**
*****************************************************************************/
BIP_API extern tBIP_STATUS BIP_DisconRefService(tBIP_CCB_HANDLE ccb_handle);
