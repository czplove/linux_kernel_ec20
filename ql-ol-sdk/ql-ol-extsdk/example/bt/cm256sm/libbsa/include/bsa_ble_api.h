...
#define BSA_BLE_ATTRIBUTE_MAX         6
#define BSA_BLE_CHAR_MAX                    8
...
#define BSA_BLE_GATT_UUID_SCAN_INT_WINDOW                   GATT_UUID_SCAN_INT_WINDOW
#define BSA_BLE_GATT_UUID_SCAN_REFRESH                      GATT_UUID_SCAN_REFRESH
...
typedef enum
{
    ...
    BSA_BLE_CL_EXEC_CMPL_EVT,     /* Execute complete event */
    ...
    BSA_BLE_SE_CONFIRM_EVT,       /* Confirm event */
...
/* callback event data for BSA_BLE_CL_EXEC_CMPL_EVT event */
typedef struct
{
    tBSA_STATUS         status;
    UINT16              conn_id;
...
#define BSA_BLE_APCF_COND_MAX_LEN BTM_BLE_APCF_STR_LEN_MAX

typedef struct
{
    tBT_UUID              uuid;          /* UUID condition */
    tBSA_BLE_UUID_MASK    uuid_mask;
}tBSA_BLE_APCF_UUID_COND;

typedef struct
{
    UINT8                   data_len;       /* <= 29 bytes */
    UINT8                   data[BSA_BLE_APCF_COND_MAX_LEN];
}tBSA_BLE_APCF_LOCAL_NAME_COND;

typedef struct
{
    UINT8                   data_len;        /* <= 29 bytes */
    UINT8                   data[BSA_BLE_APCF_COND_MAX_LEN];
    UINT8                   data_mask[BSA_BLE_APCF_COND_MAX_LEN];
}tBSA_BLE_APCF_DATA_COND;

#define BSA_BLE_APCF_BRDCAST_ADDR_FILT    BTA_BLE_APCF_BRDCAST_ADDR_FILT
#define BSA_BLE_APCF_SERV_DATA_CHG_FILT   BTA_BLE_APCF_SERV_DATA_CHG_FILT
#define BSA_BLE_APCF_SERV_UUID            BTA_BLE_APCF_SERV_UUID
#define BSA_BLE_APCF_SERV_SOLC_UUID       BTA_BLE_APCF_SERV_SOLC_UUID
#define BSA_BLE_APCF_LOC_NAME_CHECK       BTA_BLE_APCF_LOC_NAME_CHECK
#define BSA_BLE_APCF_MANUF_NAME_CHECK     BTA_BLE_APCF_MANUF_NAME_CHECK
#define BSA_BLE_APCF_SERV_DATA_CHECK      BTA_BLE_APCF_SERV_DATA_CHECK
typedef tBTA_BLE_APCF_FEAT_SEL tBSA_BLE_APCF_FEAT_SEL;

#define BSA_BLE_APCF_LIST_LOGIC_OR     BTA_BLE_APCF_LIST_LOGIC_OR
#define BSA_BLE_APCF_LIST_LOGIC_AND    BTA_BLE_APCF_LIST_LOGIC_AND
typedef tBTA_BLE_APCF_LIST_LOGIC_TYPE tBSA_BLE_APCF_LIST_LOGIC_TYPE;

#define BSA_BLE_APCF_FILT_LOGIC_OR     BTA_BLE_APCF_FILT_LOGIC_OR
#define BSA_BLE_APCF_FILT_LOGIC_AND    BTA_BLE_APCF_FILT_LOGIC_AND
typedef tBTA_BLE_APCF_FILT_LOGIC_TYPE tBSA_BLE_APCF_FILT_LOGIC_TYPE;

typedef tBTA_BLE_APCF_RSSI_THRESHOLD tBSA_BLE_APCF_RSSI_THRESHOLD;

typedef struct
{
    tBSA_BLE_APCF_FEAT_SEL           feat_seln;
    tBSA_BLE_APCF_LIST_LOGIC_TYPE    logic_type;
    tBSA_BLE_APCF_FILT_LOGIC_TYPE    filter_logic_type;
    tBSA_BLE_APCF_RSSI_THRESHOLD     rssi_high_thres;
}tBSA_BLE_APCF_FILTER_SET_COND;

typedef union
{
    tBLE_BD_ADDR                    target_addr;
    tBSA_BLE_APCF_LOCAL_NAME_COND   local_name; /* lcoal name filtering */
    tBSA_BLE_APCF_DATA_COND         data;       /* manufactuer/service data filtering */
    tBSA_BLE_APCF_UUID_COND         uuid;       /* service/solicitated UUID filtering */
    tBSA_BLE_APCF_FILTER_SET_COND   filter_setting;
}tBSA_BLE_APCF_COND_PARAM;

#define BSA_BLE_APCF_FILTER_SETTING   BTA_BLE_APCF_FILTER_SETTING
#define BSA_BLE_APCF_ADDR_FILTER      BTA_BLE_APCF_ADDR_FILTER
#define BSA_BLE_APCF_SRVC_UUID        BTA_BLE_APCF_SRVC_UUID
#define BSA_BLE_APCF_SRVC_SOL_UUID    BTA_BLE_APCF_SRVC_SOL_UUID
#define BSA_BLE_APCF_LOCAL_NAME       BTA_BLE_APCF_LOCAL_NAME
#define BSA_BLE_APCF_MANU_DATA        BTA_BLE_APCF_MANU_DATA
#define BSA_BLE_APCF_SRVC_DATA        BTA_BLE_APCF_SRVC_DATA
typedef tBTA_BLE_APCF_COND_TYPE  tBSA_BLE_APCF_COND_TYPE;

#define BSA_BLE_APCF_COND_ADD     BTA_BLE_APCF_COND_ADD
#define BSA_BLE_APCF_COND_DELETE  BTA_BLE_APCF_COND_DELETE
#define BSA_BLE_APCF_COND_CLEAR   BTA_BLE_APCF_COND_CLEAR
typedef tBTA_BLE_APCF_COND_OP tBSA_BLE_APCF_COND_OP;
...
typedef union
{
    ...
    tBSA_BLE_CL_EXEC_CMPL_MSG    cli_exec_cmpl;     /* BSA_BLE_CL_EXEC_CMPL_EVT */
...
typedef tBTA_BLE_APCF_FILT_INDEX tBSA_BLE_APCF_FILT_INDEX;

typedef struct
{
    tBSA_BLE_APCF_COND_OP    action;
    tBSA_BLE_APCF_FILT_INDEX filter_index;
    tBSA_BLE_APCF_COND_TYPE  cond_type;
    tBSA_BLE_APCF_COND_PARAM cond;
    tBSA_STATUS              status;
} tBSA_BLE_APCF_CFG;
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_BleClRefreshInit(tBSA_BLE_CL_REFRESH *p_cfg);

/*******************************************************************************
 **
 ** Function         BSA_BleClRefresh
 **
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_BleClRefresh(tBSA_BLE_CL_REFRESH *p_cfg);
...
/*******************************************************************************
 **
 ** Function         BSA_BleApcfEnableInit
 **
 ** Description      Initialize structure containing API parameters with default values
 **
 ** Parameters       Pointer on structure containing API parameters
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_BleApcfEnableInit(tBSA_BLE_APCF_ENABLE *p_req);

/*******************************************************************************
 **
 ** Function         BSA_BleApcfEnable
 **
 ** Description      Function to enable APCF
 **
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_BleApcfEnable(tBSA_BLE_APCF_ENABLE *p_req);

/*******************************************************************************
 **
 ** Function         BSA_BleApcfCfgInit
 **
 ** Description      Initialize structure containing API parameters with default values
 **
 ** Parameters       Pointer on structure containing API parameters
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_BleApcfCfgInit(tBSA_BLE_APCF_CFG *p_req);

/*******************************************************************************
 **
 ** Function         BSA_BleApcfCfg
 **
 ** Description      Function to set APCF
 **
 ** Parameters       Pointer to structure containing API parameters
 **
 ** Returns          tBSA_STATUS
