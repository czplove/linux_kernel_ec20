...
#define ETHER_ADDR_PACK_LOW(addr)  (((addr)->octet[0])<<24 | ((addr)->octet[1])<<16 | \
	((addr)->octet[2])<<8 | ((addr)->octet[3]))
#define ETHER_ADDR_PACK_HI(addr)   (((addr)->octet[4])<<24 | ((addr)->octet[5])<<16)
