...
**
*******************************************************************************/
BTA_API extern BOOLEAN bta_avk_co_audio_init(tBTA_AVK_HNDL hndl, UINT8 *p_codec_type,
...
**
*******************************************************************************/
BTA_API extern void bta_avk_co_audio_disc_res(tBTA_AVK_HNDL hndl, UINT8 num_seps, 
...
**
*******************************************************************************/
BTA_API extern UINT8 bta_avk_co_audio_getconfig(tBTA_AVK_HNDL hndl, tBTA_AVK_CODEC codec_type,
...
**
*******************************************************************************/
BTA_API extern void bta_avk_co_audio_setconfig(tBTA_AVK_HNDL hndl, tBTA_AVK_CODEC codec_type, 
...
**
*******************************************************************************/
BTA_API extern void bta_avk_co_audio_open(tBTA_AVK_HNDL hndl, tBTA_AVK_CODEC codec_type, 
...
**
*******************************************************************************/
BTA_API extern void bta_avk_co_audio_close(tBTA_AVK_HNDL hndl);
...
**
*******************************************************************************/
BTA_API extern void bta_avk_co_audio_delay(tBTA_AVK_HNDL hndl, UINT16 delay, UINT8 err);
...
**
*******************************************************************************/
BTA_API extern void bta_avk_co_audio_start(tBTA_AVK_HNDL hndl, tBTA_AVK_CODEC codec_type);
...
**
*******************************************************************************/
BTA_API extern void bta_avk_co_audio_stop(tBTA_AVK_HNDL hndl);
...
**
*******************************************************************************/
BTA_API extern void bta_avk_co_audio_data(tBTA_AVK_HNDL hndl, BD_ADDR bd_addr, 
                                        tBTA_AVK_CODEC codec_type, BT_HDR *p_pkt,
