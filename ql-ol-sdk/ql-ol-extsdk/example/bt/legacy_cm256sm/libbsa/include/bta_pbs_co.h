...
/*******************************************************************************
**
** Function         bta_pbs_co_init_version_database_info
**
** Description      This function is called by BTA to initialize pb primary and secondary version
                    counter and database ID.
**
**
*******************************************************************************/
BTA_API extern tBTA_PBS_CO_STATUS bta_pbs_co_init_version_database_info(void);

/*******************************************************************************
**
** Function         bta_pbs_co_update_version_database_info
**
** Description      This function is called by BTA to update primary and secondary version
                    counter and database ID.
**
**
*******************************************************************************/
BTA_API extern tBTA_PBS_CO_STATUS bta_pbs_co_update_version_database_info(BOOLEAN update_pri_ver, BOOLEAN update_sec_ver, BOOLEAN update_db_id);
...
/*******************************************************************************
**
** Function         bta_pbs_co_get_vcard_handle_by_uid
**
** Description      This function is called to get the Vcard handle using X-BT-UID
**
** Parameters       UID
**
** Returns          vcard handle
**
*******************************************************************************/
BTA_API extern char * bta_pbs_co_get_vcard_handle_by_uid(char *p_name);
/*******************************************************************************
**
