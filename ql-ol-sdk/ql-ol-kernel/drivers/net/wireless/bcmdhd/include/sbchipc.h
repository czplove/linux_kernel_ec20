...
typedef volatile struct {
	...
	uint32  mac_res_req_timer;	
	uint32  mac_res_req_mask;	
	uint32  PAD[18];
	...
	uint32  PAD[14];
	uint32  pmuintstatus;		
	uint32	extwakeupstatus;	
	uint32  watchdog_res_mask;	
	uint32	PAD[1];		
	uint32	swscratch;		
	uint32	PAD[3];		
	uint32	extwakemask[2]; 
	uint32	PAD[2];		
	uint32	extwakereqmask[2]; 
	uint32	PAD[2];		
	uint32	pmuintctrl0;	
	uint32	pmuintctrl1;	
	uint32	PAD[2];
	uint32	extwakectrl[2] ;   
} pmuregs_t;
