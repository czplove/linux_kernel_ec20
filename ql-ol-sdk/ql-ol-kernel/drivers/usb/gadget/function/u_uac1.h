...
#define UAC1_AUDIO_PLAYBACK_BUF_SIZE   256 //modify by carl.yin 20ms PCM data //256	/* Matches with Audio driver */
#define UAC1_AUDIO_CAPTURE_BUF_SIZE    256 //modify by carl.yin 20ms PCM data //256	/* Matches with Audio driver */
