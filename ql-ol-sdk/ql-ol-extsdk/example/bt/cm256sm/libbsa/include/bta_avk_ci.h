...
**
*******************************************************************************/
BTA_API extern void bta_avk_ci_setconfig(tBTA_AVK_HNDL hndl, UINT8 err_code, UINT8 category, BD_ADDR bd_addr);
...
**
*******************************************************************************/
BTA_API extern void bta_avk_ci_cp_scms(tBTA_AVK_HNDL hndl, BOOLEAN enable, UINT8 scms_hdr);
