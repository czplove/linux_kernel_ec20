...
#define BSA_DG_GET_SDP_EVT      3       /* Get SDP */
...
#define BSA_DG_MAX_NUM_OF_UUID  10

typedef struct
{
    tBT_UUID                uuid[BSA_DG_MAX_NUM_OF_UUID]; /* Addr of next linked attr     */
    UINT16                  num_of_uuid;
} tBSA_DG_SDP_DISC_ATTR;
...
typedef struct {
    ...
    char      name[BSA_SERVICE_NAME_LEN];
    BOOLEAN complete;   /* SDP search complete */
    tBSA_DG_SDP_DISC_ATTR  attrs;
} tBSA_DG_GET_SDP_MSG;
...
/*******************************************************************************
 **
 ** Function         BSA_DgGetSdpInit
 **
 ** Description      Init structure tBSA_DG_GET_SDP to be used with BSA_DgGetSdp
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_DgGetSdpInit(tBSA_DG_GET_SDP * p_req);

/*******************************************************************************
 **
 ** Function         BSA_DgGetSdp
 **
 ** Description      Performs SDP on specified device
 **
 ** Returns          Status
 **
 *******************************************************************************/
tBSA_STATUS BSA_DgGetSdp(tBSA_DG_GET_SDP * p_req);
